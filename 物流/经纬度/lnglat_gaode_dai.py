...
if __name__ == "__main__":
    ...
    inputpath = "/root/lnglat_gaode/input/"
    data = pd.read_excel(inputpath + fileName)

    # 导出数据路径
    outpath_gaode = "/root/lnglat_gaode/daily_distance/input/"
    name_UTF8_gaode = date + "Info_lnglat_gaode.csv"


    # 选取有用字段
    df = data[["所在省","所在市","收货人地址","订单编号","所在县"]]
