...
print(df1_tui_EMS[['EMS快递员','EMS快递员电话']])

# outpath = "G:/work/logistica/output/TUI/1901/"
# writer = pd.ExcelWriter(outpath)
# df1_tui_ZT.to_excel(writer + "1901_tui_ZT.xlsx",sheet_name="ZT",index=False)
# df1_tui_JD.to_excel(writer + "1901_tui_ZT.xlsx",sheet_name="JD",index=False)
# df1_tui_EMS.to_excel(writer + "1901_tui_ZT.xlsx",sheet_name="EMS",index=False)
# df1_tui_YZ.to_excel(writer + "1901_tui_ZT.xlsx",sheet_name="YZ",index=False)
# df1_tui_hyytes.to_excel(writer + "1901_tui_ZT.xlsx",sheet_name="hyytes",index=False)
# df1_tui_YD.to_excel(writer + "1901_tui_ZT.xlsx",sheet_name="YD",index=False)
# writer.save()
