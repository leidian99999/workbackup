...
if __name__=='__main__':
	...
	for filepath in allfilepaths:
		...
		# filename = ''.join(re.findall(r"F:\temp\190513\diyi\(.*)",filepath))# 输出前2个sheet并保存
		filename = ''.join(re.findall("数据展示-(.*)取数.xlsx",filepath))# 输出前2个sheet并保存

		# print(filename)
		outpath1 = "F:\\temp\\190513\\disan_out/" + "前2个sheet" + filename + ".xlsx"
