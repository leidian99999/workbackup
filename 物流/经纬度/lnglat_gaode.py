...
if __name__ == "__main__":
    ...
    fileName = "JDXX.xlsx"
    pinyin = "JDXX"
    inputpath = "/root/PycharmProjects/lnglat/"
    data = pd.read_excel(inputpath + fileName)

    # 导出数据路径
    outpath_gaode = "/root/PycharmProjects/lnglat/"
    name_ANSI_gaode = date + "Info_lnglat_" + pinyin + "_gaode.xlsx"
    name_UTF8_gaode = date + "Info_lnglat_" + pinyin + "_gaodexxx.csv"
    ...
    # 解析高德
    data_gaode = parse_gaode(df,df["address_all"][0:10])
